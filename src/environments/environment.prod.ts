export const environment = {
 ...
 config : {
  ...
  query_train : 'https://www.googleapis.com/youtube/v3/search?order=date&part=snippet&channelId=UCvjgXvBlbQiydffZU7m1_aw&maxResults=25&key=AIzaSyBIxUDftgsBPWkib-g1j3N6hklOyShuKfc',
